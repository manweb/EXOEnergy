...
def init():
  ...
  SourceRunsFileName = '../data/SourceRunsInfo_Phase1_20170411.txt'
  RecoFileName = '/nfs/slac/g/exo-userdata/users/mjjewell/Analysis/Reproc_Phase1_ClusterRiseTime_CopyDenoised/[RunNumber]/reproc0000[RunNumber]-*.root'
  DataTreeFileName = '/nfs/slac/g/exo_data6/groups/Energy/data/WIPP/preprocessed/2017_Phase1_v2/ForCalibration/run_[RunNumber]_tree.root'
  SelectionTreeFileName = '/nfs/slac/g/exo_data6/groups/Energy/data/WIPP/selection/2017_Phase1_v2/ForCalibration/%s/run_[RunNumber]_tree.root'%(cutName)
  DataMultiplicityWildcard = '[MULTIPLICITY]'
  DataId = 'run_[RunNumber]_[MULTIPLICITY]'
  MCTreeFileName = '/nfs/slac/g/exo_data6/groups/Fitting/data/MC/preprocessed/2017_Phase1_v2/group2/'
  MCSelectionFileName = '/nfs/slac/g/exo_data6/groups/Fitting/data/MC/selection/2017_Phase1_v2/group2/fv_162_10_182/'
  minWeek = 10
  maxWeek = 125
  ...
  calibrationChannel = 'Ionization'
  applyZCorrection = True
  ZCorrectionFlavor = 'linear-2015-v1'
  CalibrationOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/calibration/2017_Phase1_v2_ionization/ionization/%s/'%(cutName)
  AngleFitterOutput = '/nfs/slac/g/exo_data4/users/Energy/data/results/angle/2017_Phase1_NonDenoised_071217/'
  isDenoised = False
  useAngleFile = True
  angleFile = '/nfs/slac/g/exo_data4/users/maweber/software/Devel/EXOEnergy/scripts/WeeklyAngle_Phase1_NonDenoised_071217.txt'
